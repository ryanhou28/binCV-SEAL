...
/* PCL addition: Headerfile for global params */
...
int main(int argc, char *argv[]) {
    ...
    // SEALinit(true, cmd.cmd.seal.sealParamsFile, true);
    SEALinit(true, cmd.cmd.seal.sealParamsFile, true);
    SEAL_PEmu_init(
        cmd.cmd.seal.sealPowerEmulatorMode,
        cmd.cmd.seal.sealPowerEmulatorStoragePath,
        cmd.cmd.main.inputPath,
        argv
    );
